...
function love.load()
	...
	-- Definindo a música de fundo
	soundBack = love.audio.newSource( "Musics/Background.mp3", "stream" )
	texto = ""
end
...
function love.update( dt )
	...
	-- Definindo Volume e tocando
	soundBack:setVolume( volume )
	textoVolume = volume
	soundBack:play()
...
function love.draw()
	...
	love.graphics.print( textoVolume, 100, 100 )
...
function love.keypressed( key )
	--isGrabbed Inicia FALSE
	texto = love.mouse.isGrabbed() and "Cursor preso na janela!" or "Cursor solto!"
	if key == "tab" then 
